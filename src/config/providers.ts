...
export const SYSTEM_PROVIDERS_CONFIG: Partial<Record<Exclude<SystemProviderId, 'cherryai'>, SystemProvider>> = {
  // cherryin: {
  //   id: 'cherryin',
  //   name: 'CherryIN',
  //   type: 'openai',
...
export const SYSTEM_PROVIDERS: SystemProvider[] = Object.values(SYSTEM_PROVIDERS_CONFIG).filter(
  (provider): provider is SystemProvider => provider !== undefined
)
